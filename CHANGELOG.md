...
* (store) [#13935](https://github.com/cosmos/cosmos-sdk/pull/13935) Skip snapshotting of stores which fail to create an exporter.
* (store) [#13935](https://github.com/cosmos/cosmos-sdk/pull/13935) Enable rootmulti logging by setting environment variable LOG_ROOTMULTI=1
